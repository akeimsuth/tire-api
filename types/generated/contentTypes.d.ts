...
export interface ApiBidBid extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estimatedArrival: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    requestId: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiProviderProvider extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    user: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    vehicleSpecs: Schema.Attribute.Text;
    walletBalance: Schema.Attribute.Decimal;
...
export interface ApiRatingRating extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    provider_id: Schema.Attribute.Relation<
      'manyToOne',
      'api::provider.provider'
    >;
    publishedAt: Schema.Attribute.DateTime;
    rating: Schema.Attribute.Integer;
    request_id: Schema.Attribute.Relation<
      'oneToOne',
      'api::service-request.service-request'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiServiceRequestServiceRequest
  ...
  attributes: {
    ...
    tireSize: Schema.Attribute.String;
    tireStatus: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    business: Schema.Attribute.Relation<'oneToOne', 'api::provider.provider'>;
